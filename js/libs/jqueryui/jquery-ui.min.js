...
function W(a){for(var b;a.length&&a[0]!==document;){b=a.css("position");if("absolute"===b||"relative"===b||"fixed"===b)if(b=parseInt(a.css("zIndex"),10),!isNaN(b)&&0!==b)return b;a=a.parent()}return 0}function Q(){this._curInst=null;this._keyEvent=!1;this._disabledInputs=[];this._inDialog=this._datepickerShowing=!1;this._mainDivId="ui-datepicker-div";this._inlineClass="ui-datepicker-inline";this._appendClass="ui-datepicker-append";this._triggerClass="ui-datepicker-trigger";this._dialogClass="ui-datepicker-dialog";
...
"mouseover",S)}function S(){d.datepicker._isDisabledDatepicker(J.inline?J.dpDiv.parent()[0]:J.input[0])||(d(this).parents(".ui-datepicker-calendar").find("a").removeClass("ui-state-hover"),d(this).addClass("ui-state-hover"),-1!==this.className.indexOf("ui-datepicker-prev")&&d(this).addClass("ui-datepicker-prev-hover"),-1!==this.className.indexOf("ui-datepicker-next")&&d(this).addClass("ui-datepicker-next-hover"))}function K(a,b){d.extend(a,b);for(var c in b)null==b[c]&&(a[c]=b[c]);return a}function D(a){return function(){var b=
...
b._childConstructors.push(k);d.widget.bridge(a,k);return k};d.widget.extend=function(a){for(var b=T.call(arguments,1),c=0,e=b.length,f,g;c<e;c++)for(f in b[c])g=b[c][f],b[c].hasOwnProperty(f)&&void 0!==g&&(d.isPlainObject(g)?a[f]=d.isPlainObject(a[f])?d.widget.extend({},a[f],g):d.widget.extend({},g):a[f]=g);return a};d.widget.bridge=function(a,b){var c=b.prototype.widgetFullName||a;d.fn[a]=function(e){var f="string"===typeof e,g=T.call(arguments,1),h=this;e=!f&&g.length?d.widget.extend.apply(null,
...
(e={duration:e});var h=!d.isEmptyObject(e);e.complete=f;e.delay&&c.delay(e.delay);if(h&&d.effects&&d.effects.effect[g])c[a](e);else if(g!==a&&c[g])c[g](e.duration,e.easing,f);else c.queue(function(b){d(this)[a]();f&&f.call(c[0]);b()})}});var H=!1;d(document).mouseup(function(){H=!1});d.widget("ui.mouse",{version:"1.11.2",options:{cancel:"input,textarea,button,select,option",distance:1,delay:0},_mouseInit:function(){var a=this;this.element.bind("mousedown."+this.widgetName,function(b){return a._mouseDown(b)}).bind("click."+
...
d.data(a.target,this.widgetName+".preventClickEvent",!0),this._mouseStop(a));return H=!1},_mouseDistanceMet:function(a){return Math.max(Math.abs(this._mouseDownEvent.pageX-a.pageX),Math.abs(this._mouseDownEvent.pageY-a.pageY))>=this.options.distance},_mouseDelayMet:function(){return this.mouseDelayMet},_mouseStart:function(){},_mouseDrag:function(){},_mouseStop:function(){},_mouseCapture:function(){return!0}});(function(){function a(a,b,c){return[parseFloat(a[0])*(p.test(a[0])?b/100:1),parseFloat(a[1])*
(p.test(a[1])?c/100:1)]}function b(a){var b=a[0];return 9===b.nodeType?{width:a.width(),height:a.height(),offset:{top:0,left:0}}:d.isWindow(b)?{width:a.width(),height:a.height(),offset:{top:a.scrollTop(),left:a.scrollLeft()}}:b.preventDefault?{width:0,height:0,offset:{top:b.pageY,left:b.pageX}}:{width:a.outerWidth(),height:a.outerHeight(),offset:a.offset()}}d.ui=d.ui||{};var c,e,f=Math.max,g=Math.abs,h=Math.round,k=/left|center|right/,l=/top|center|bottom/,m=/[\+\-]\d+(\.[\d]+)?%?/,n=/^\w+/,p=/%$/,
...
d.fn.position=function(c){if(!c||!c.of)return q.apply(this,arguments);c=d.extend({},c);var r=d(c.of),u=d.position.getWithinInfo(c.within),y=d.position.getScrollInfo(u),x=(c.collision||"flip").split(" "),p={};var t=b(r);r[0].preventDefault&&(c.at="left top");var G=t.width;var C=t.height;var L=t.offset;var B=d.extend({},L);d.each(["my","at"],function(){var a=(c[this]||"").split(" ");1===a.length&&(a=k.test(a[0])?a.concat(["center"]):l.test(a[0])?["center"].concat(a):["center","center"]);a[0]=k.test(a[0])?
a[0]:"center";a[1]=l.test(a[1])?a[1]:"center";var b=m.exec(a[0]);var d=m.exec(a[1]);p[this]=[b?b[0]:0,d?d[0]:0];c[this]=[n.exec(a[0])[0],n.exec(a[1])[0]]});1===x.length&&(x[1]=x[0]);"right"===c.at[0]?B.left+=G:"center"===c.at[0]&&(B.left+=G/2);"bottom"===c.at[1]?B.top+=C:"center"===c.at[1]&&(B.top+=C/2);var I=a(p.at,G,C);B.left+=I[0];B.top+=I[1];return this.each(function(){var b,k=d(this),l=k.outerWidth(),m=k.outerHeight(),n=parseInt(d.css(this,"marginLeft"),10)||0,t=parseInt(d.css(this,"marginTop"),
10)||0,q=l+n+(parseInt(d.css(this,"marginRight"),10)||0)+y.width,v=m+t+(parseInt(d.css(this,"marginBottom"),10)||0)+y.height,w=d.extend({},B),M=a(p.my,k.outerWidth(),k.outerHeight());"right"===c.my[0]?w.left-=l:"center"===c.my[0]&&(w.left-=l/2);"bottom"===c.my[1]?w.top-=m:"center"===c.my[1]&&(w.top-=m/2);w.left+=M[0];w.top+=M[1];e||(w.left=h(w.left),w.top=h(w.top));var D={marginLeft:n,marginTop:t};d.each(["left","top"],function(a,b){if(d.ui.position[x[a]])d.ui.position[x[a]][b](w,{targetWidth:G,targetHeight:C,
elemWidth:l,elemHeight:m,collisionPosition:D,collisionWidth:q,collisionHeight:v,offset:[I[0]+M[0],I[1]+M[1]],my:c.my,at:c.at,within:u,elem:k})});c.using&&(b=function(a){var b=L.left-w.left,d=b+G-l,e=L.top-w.top,h=e+C-m,u={target:{element:r,left:L.left,top:L.top,width:G,height:C},element:{element:k,left:w.left,top:w.top,width:l,height:m},horizontal:0>d?"left":0<b?"right":"center",vertical:0>h?"top":0<e?"bottom":"middle"};G<l&&g(b+d)<G&&(u.horizontal="center");C<m&&g(e+h)<C&&(u.vertical="middle");f(g(b),
g(d))>f(g(e),g(h))?u.important="horizontal":u.important="vertical";c.using.call(this,a,u)});k.offset(d.extend(w,{using:b}))})};d.ui.position={fit:{left:function(a,b){var c=b.within,d=c.isWindow?c.scrollLeft:c.offset.left,e=c.width,g=a.left-b.collisionPosition.marginLeft;c=d-g;var h=g+b.collisionWidth-e-d;b.collisionWidth>e?0<c&&0>=h?(b=a.left+c+b.collisionWidth-e-d,a.left+=c-b):a.left=0<h&&0>=c?d:c>h?d+e-b.collisionWidth:d:a.left=0<c?a.left+c:0<h?a.left-h:f(a.left-g,a.left)},top:function(a,b){var c=
...
f;h="left"===b.my[0]?-b.elemWidth:"right"===b.my[0]?b.elemWidth:0;var l="left"===b.at[0]?b.targetWidth:"right"===b.at[0]?-b.targetWidth:0,r=-2*b.offset[0];if(0>c){if(b=a.left+h+l+r+b.collisionWidth-e-d,0>b||b<g(c))a.left+=h+l+r}else 0<k&&(b=a.left-b.collisionPosition.marginLeft+h+l+r-f,0<b||g(b)<k)&&(a.left+=h+l+r)},top:function(a,b){var c=b.within,d=c.offset.top+c.scrollTop,e=c.height,f=c.isWindow?c.scrollTop:c.offset.top,h=a.top-b.collisionPosition.marginTop;c=h-f;var k=h+b.collisionHeight-e-f;
h="top"===b.my[1]?-b.elemHeight:"bottom"===b.my[1]?b.elemHeight:0;var l="top"===b.at[1]?b.targetHeight:"bottom"===b.at[1]?-b.targetHeight:0,r=-2*b.offset[1];0>c?(b=a.top+h+l+r+b.collisionHeight-e-d,a.top+h+l+r>c&&(0>b||b<g(c))&&(a.top+=h+l+r)):0<k&&(b=a.top-b.collisionPosition.marginTop+h+l+r-f,a.top+h+l+r>k&&(0<b||g(b)<k)&&(a.top+=h+l+r))}},flipfit:{left:function(){d.ui.position.flip.left.apply(this,arguments);d.ui.position.fit.left.apply(this,arguments)},top:function(){d.ui.position.flip.top.apply(this,
...
c=d(c).offset().left;e=10<c&&11>c;f.innerHTML="";g.removeChild(f)})()})();d.widget("ui.accordion",{version:"1.11.2",options:{active:0,animate:{},collapsible:!1,event:"click",header:"> li > :first-child,> :not(li):even",heightStyle:"auto",icons:{activeHeader:"ui-icon-triangle-1-s",header:"ui-icon-triangle-1-e"},activate:null,beforeActivate:null},hideProps:{borderTopWidth:"hide",borderBottomWidth:"hide",paddingTop:"hide",paddingBottom:"hide",height:"hide"},showProps:{borderTopWidth:"show",borderBottomWidth:"show",
...
c.attr({"aria-hidden":"true"});c.prev().attr("aria-selected","false");b.length&&c.length?c.prev().attr({tabIndex:-1,"aria-expanded":"false"}):b.length&&this.headers.filter(function(){return 0===d(this).attr("tabIndex")}).attr("tabIndex",-1);b.attr("aria-hidden","false").prev().attr({"aria-selected":"true",tabIndex:0,"aria-expanded":"true"})},_animate:function(a,b,c){var d,f,g=this,h=0,k=a.length&&(!b.length||a.index()<b.index()),l=this.options.animate||{};k=k&&l.down||l;var m=function(){g._toggleComplete(c)};
"number"===typeof k&&(f=k);"string"===typeof k&&(d=k);d=d||k.easing||l.easing;f=f||k.duration||l.duration;if(!b.length)return a.animate(this.showProps,f,d,m);if(!a.length)return b.animate(this.hideProps,f,d,m);var n=a.show().outerHeight();b.animate(this.hideProps,{duration:f,easing:d,step:function(a,b){b.now=Math.round(a)}});a.hide().animate(this.showProps,{duration:f,easing:d,complete:m,step:function(a,c){c.now=Math.round(a);"height"!==c.prop?h+=c.now:"content"!==g.options.heightStyle&&(c.now=Math.round(n-
b.outerHeight()-h),h=0)}})},_toggleComplete:function(a){var b=a.oldPanel;b.removeClass("ui-accordion-content-active").prev().removeClass("ui-corner-top").addClass("ui-corner-all");b.length&&(b.parent()[0].className=b.parent()[0].className);this._trigger("activate",null,a)}});d.widget("ui.menu",{version:"1.11.2",defaultElement:"<ul>",delay:300,options:{icons:{submenu:"ui-icon-carat-1-e"},items:"> *",menus:"ul",position:{my:"left-1 top",at:"right top"},role:"menu",blur:null,focus:null,select:null},
...
d("<div>").text(b).appendTo(this.liveRegion)}}});var N,Z=function(){var a=d(this);setTimeout(function(){a.find(":ui-button").button("refresh")},1)},V=function(a){var b=a.name,c=a.form,e=d([]);b&&(b=b.replace(/'/g,"\\'"),e=c?d(c).find("[name='"+b+"'][type=radio]"):d("[name='"+b+"'][type=radio]",a.ownerDocument).filter(function(){return!this.form}));return e};d.widget("ui.button",{version:"1.11.2",defaultElement:"<button>",options:{disabled:null,text:!0,label:null,icons:{primary:null,secondary:null}},
...
"false")}):(this.buttonElement.bind("mousedown"+this.eventNamespace,function(){if(b.disabled)return!1;d(this).addClass("ui-state-active");N=this;a.document.one("mouseup",function(){N=null})}).bind("mouseup"+this.eventNamespace,function(){if(b.disabled)return!1;d(this).removeClass("ui-state-active")}).bind("keydown"+this.eventNamespace,function(a){if(b.disabled)return!1;a.keyCode!==d.ui.keyCode.SPACE&&a.keyCode!==d.ui.keyCode.ENTER||d(this).addClass("ui-state-active")}).bind("keyup"+this.eventNamespace+
...
"ui-button-icon-only"),this.hasTitle||a.attr("title",d.trim(b)))):f.push("ui-button-text-only");a.addClass(f.join(" "))}}});d.widget("ui.buttonset",{version:"1.11.2",options:{items:"button, input[type=button], input[type=submit], input[type=reset], input[type=checkbox], input[type=radio], a, :data(ui-button)"},_create:function(){this.element.addClass("ui-buttonset")},_init:function(){this.refresh()},_setOption:function(a,b){"disabled"===a&&this.buttons.button("option",a,b);this._super(a,b)},refresh:function(){var a=
...
d("body").append(this._dialogInput),a=this._dialogInst=this._newInst(this._dialogInput,!1),a.settings={},d.data(this._dialogInput[0],"datepicker",a));K(a.settings,e||{});b=b&&b.constructor===Date?this._formatDate(a,b):b;this._dialogInput.val(b);this._pos=f?f.length?f:[f.pageX,f.pageY]:null;if(!this._pos){b=document.documentElement.clientWidth;e=document.documentElement.clientHeight;f=document.documentElement.scrollLeft||document.body.scrollLeft;var g=document.documentElement.scrollTop||document.body.scrollTop;
...
d.datepicker._curInst!==b&&(d.datepicker._curInst.dpDiv.stop(!0,!0),b&&d.datepicker._datepickerShowing&&d.datepicker._hideDatepicker(d.datepicker._curInst.input[0]));var c=(c=d.datepicker._get(b,"beforeShow"))?c.apply(a,[a,b]):{};if(!1!==c){K(b.settings,c);b.lastVal=null;d.datepicker._lastInput=a;d.datepicker._setDateFromField(b);d.datepicker._inDialog&&(a.value="");d.datepicker._pos||(d.datepicker._pos=d.datepicker._findPos(a),d.datepicker._pos[1]+=a.offsetHeight);var e=!1;d(a).parents().each(function(){e|=
...
0;b.top-=c&&b.top===a.input.offset().top+h?d(document).scrollTop():0;b.left-=Math.min(b.left,b.left+e>k&&k>e?Math.abs(b.left+e-k):0);b.top-=Math.min(b.top,b.top+f>l&&l>f?Math.abs(f+h):0);return b},_findPos:function(a){var b=this._getInst(a);for(b=this._get(b,"isRTL");a&&("hidden"===a.type||1!==a.nodeType||d.expr.filters.hidden(a));)a=a[b?"previousSibling":"nextSibling"];a=d(a).offset();return[a.left,a.top]},_hideDatepicker:function(a){var b=this._curInst;if(b&&(!a||b===d.data(a,"datepicker"))&&this._datepickerShowing){a=
...
null)||this._defaults.dayNames,l=(c?c.monthNamesShort:null)||this._defaults.monthNamesShort,m=(c?c.monthNames:null)||this._defaults.monthNames,n=c=-1,p=-1,q=-1,t=!1,r=function(b){(b=e+1<a.length&&a.charAt(e+1)===b)&&e++;return b},u=function(a){var c=r(a);c="@"===a?14:"!"===a?20:"y"===a&&c?4:"o"===a?3:2;a=new RegExp("^\\d{"+("y"===a?c:1)+","+c+"}");a=b.substring(f).match(a);if(!a)throw"Missing number at position "+f;f+=a[0].length;return parseInt(a[0],10)},y=function(a,c,e){var g=-1;a=d.map(r(a)?e:
c,function(a,b){return[[b,a]]}).sort(function(a,b){return-(a[1].length-b[1].length)});d.each(a,function(a,c){a=c[1];if(b.substr(f,a.length).toLowerCase()===a.toLowerCase())return g=c[0],f+=a.length,!1});if(-1!==g)return g+1;throw"Unknown name at position "+f;},x=function(){if(b.charAt(f)!==a.charAt(e))throw"Unexpected literal at position "+f;f++};for(e=0;e<a.length;e++)if(t)"'"!==a.charAt(e)||r("'")?x():t=!1;else switch(a.charAt(e)){case "d":p=u("d");break;case "D":y("D",h,k);break;case "o":q=u("o");
break;case "m":n=u("m");break;case "M":n=y("M",l,m);break;case "y":c=u("y");break;case "@":var v=new Date(u("@"));c=v.getFullYear();n=v.getMonth()+1;p=v.getDate();break;case "!":v=new Date((u("!")-this._ticksTo1970)/1E4);c=v.getFullYear();n=v.getMonth()+1;p=v.getDate();break;case "'":r("'")?x():t=!0;break;default:x()}if(f<b.length&&(h=b.substr(f),!/^\s+/.test(h)))throw"Extra/unparsed characters found in date: "+h;-1===c?c=(new Date).getFullYear():100>c&&(c+=(new Date).getFullYear()-(new Date).getFullYear()%
...
b,c){if(!b)return"";var d,f=(c?c.dayNamesShort:null)||this._defaults.dayNamesShort,g=(c?c.dayNames:null)||this._defaults.dayNames,h=(c?c.monthNamesShort:null)||this._defaults.monthNamesShort;c=(c?c.monthNames:null)||this._defaults.monthNames;var k=function(b){(b=d+1<a.length&&a.charAt(d+1)===b)&&d++;return b},l=function(a,b,c){b=""+b;if(k(a))for(;b.length<c;)b="0"+b;return b},m=function(a,b,c,d){return k(a)?d[b]:c[b]},n="",p=!1;if(b)for(d=0;d<a.length;d++)if(p)"'"!==a.charAt(d)||k("'")?n+=a.charAt(d):
p=!1;else switch(a.charAt(d)){case "d":n+=l("d",b.getDate(),2);break;case "D":n+=m("D",b.getDay(),f,g);break;case "o":n+=l("o",Math.round(((new Date(b.getFullYear(),b.getMonth(),b.getDate())).getTime()-(new Date(b.getFullYear(),0,0)).getTime())/864E5),3);break;case "m":n+=l("m",b.getMonth()+1,2);break;case "M":n+=m("M",b.getMonth(),h,c);break;case "y":n+=k("y")?b.getFullYear():(10>b.getYear()%100?"0":"")+b.getYear()%100;break;case "@":n+=b.getTime();break;case "!":n+=1E4*b.getTime()+this._ticksTo1970;
break;case "'":k("'")?n+="'":p=!0;break;default:n+=a.charAt(d)}return n},_possibleChars:function(a){var b,c="",d=!1,f=function(c){(c=b+1<a.length&&a.charAt(b+1)===c)&&b++;return c};for(b=0;b<a.length;b++)if(d)"'"!==a.charAt(b)||f("'")?c+=a.charAt(b):d=!1;else switch(a.charAt(b)){case "d":case "m":case "y":case "@":c+="0123456789";break;case "D":case "M":return null;case "'":f("'")?c+="'":d=!0;break;default:c+=a.charAt(b)}return c},_get:function(a,b){return void 0!==a.settings[b]?a.settings[b]:this._defaults[b]},
...
this._determineDate(a,this._get(a,"defaultDate"),new Date))},_determineDate:function(a,b,c){var e=function(a){var b=new Date;b.setDate(b.getDate()+a);return b},f=function(b){try{return d.datepicker.parseDate(d.datepicker._get(a,"dateFormat"),b,d.datepicker._getFormatConfig(a))}catch(p){}var c=(b.toLowerCase().match(/^c/)?d.datepicker._getDate(a):null)||new Date,e=c.getFullYear(),f=c.getMonth();c=c.getDate();for(var g=/([+\-]?[0-9]+)\s*(d|D|w|W|m|M|y|Y)?/g,n=g.exec(b);n;){switch(n[2]||"d"){case "d":case "D":c+=
parseInt(n[1],10);break;case "w":case "W":c+=7*parseInt(n[1],10);break;case "m":case "M":f+=parseInt(n[1],10);c=Math.min(c,d.datepicker._getDaysInMonth(e,f));break;case "y":case "Y":e+=parseInt(n[1],10),c=Math.min(c,d.datepicker._getDaysInMonth(e,f))}n=g.exec(b)}return new Date(e,f,c)};if(b=(b=null==b||""===b?c:"string"===typeof b?f(b):"number"===typeof b?isNaN(b)?c:e(b):new Date(b.getTime()))&&"Invalid Date"===b.toString()?c:b)b.setHours(0),b.setMinutes(0),b.setSeconds(0),b.setMilliseconds(0);return this._daylightSavingAdjust(b)},
...
"isRTL");var k=this._get(a,"showButtonPanel");var l=this._get(a,"hideIfNoPrevNext");var m=this._get(a,"navigationAsDateFormat");var n=this._getNumberOfMonths(a),p=this._get(a,"showCurrentAtPos");var q=this._get(a,"stepMonths");var t=1!==n[0]||1!==n[1],r=this._daylightSavingAdjust(a.currentDay?new Date(a.currentYear,a.currentMonth,a.currentDay):new Date(9999,9,9)),u=this._getMinMaxDate(a,"min"),y=this._getMinMaxDate(a,"max");p=a.drawMonth-p;var x=a.drawYear;0>p&&(p+=12,x--);if(y){var v=this._daylightSavingAdjust(new Date(y.getFullYear(),
y.getMonth()-n[0]*n[1]+1,y.getDate()));for(v=u&&v<u?u:v;this._daylightSavingAdjust(new Date(x,p,1))>v;)p--,0>p&&(p=11,x--)}a.drawMonth=p;a.drawYear=x;v=this._get(a,"prevText");v=m?this.formatDate(v,this._daylightSavingAdjust(new Date(x,p-q,1)),this._getFormatConfig(a)):v;v=this._canAdjustMonth(a,-1,x,p)?"<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='"+v+"'><span class='ui-icon ui-icon-circle-triangle-"+(h?"e":"w")+"'>"+v+"</span></a>":l?"":"<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='"+
v+"'><span class='ui-icon ui-icon-circle-triangle-"+(h?"e":"w")+"'>"+v+"</span></a>";var w=this._get(a,"nextText");w=m?this.formatDate(w,this._daylightSavingAdjust(new Date(x,p+q,1)),this._getFormatConfig(a)):w;l=this._canAdjustMonth(a,1,x,p)?"<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='"+w+"'><span class='ui-icon ui-icon-circle-triangle-"+(h?"w":"e")+"'>"+w+"</span></a>":l?"":"<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='"+w+"'><span class='ui-icon ui-icon-circle-triangle-"+
(h?"w":"e")+"'>"+w+"</span></a>";q=this._get(a,"currentText");w=this._get(a,"gotoCurrent")&&a.currentDay?r:g;q=m?this.formatDate(q,w,this._getFormatConfig(a)):q;m=a.inline?"":"<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>"+this._get(a,"closeText")+"</button>";k=k?"<div class='ui-datepicker-buttonpane ui-widget-content'>"+(h?m:"")+(this._isInRange(a,w)?"<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>"+
q+"</button>":"")+(h?"":m)+"</div>":"";m=parseInt(this._get(a,"firstDay"),10);m=isNaN(m)?0:m;q=this._get(a,"showWeek");w=this._get(a,"dayNames");var G=this._get(a,"dayNamesMin");var C=this._get(a,"monthNames");var L=this._get(a,"monthNamesShort");var B=this._get(a,"beforeShowDay");var I=this._get(a,"showOtherMonths");var Y=this._get(a,"selectOtherMonths");var U=this._getDefaultDate(a);var D="";A;for(b=0;b<n[0];b++){var J="";this.maxRows=4;for(c=0;c<n[1];c++){var K=this._daylightSavingAdjust(new Date(x,
p,a.selectedDay));var A=" ui-corner-all";var E="";if(t){E+="<div class='ui-datepicker-group";if(1<n[1])switch(c){case 0:E+=" ui-datepicker-group-first";A=" ui-corner-"+(h?"right":"left");break;case n[1]-1:E+=" ui-datepicker-group-last";A=" ui-corner-"+(h?"left":"right");break;default:E+=" ui-datepicker-group-middle",A=""}E+="'>"}E+="<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix"+A+"'>"+(/all|left/.test(A)&&0===b?h?l:v:"")+(/all|right/.test(A)&&0===b?h?v:l:"")+this._generateMonthYearHeader(a,
p,x,u,y,0<b||0<c,C,L)+"</div><table class='ui-datepicker-calendar'><thead><tr>";var F=q?"<th class='ui-datepicker-week-col'>"+this._get(a,"weekHeader")+"</th>":"";for(A=0;7>A;A++){var z=(A+m)%7;F+="<th scope='col'"+(5<=(A+m+6)%7?" class='ui-datepicker-week-end'":"")+"><span title='"+w[z]+"'>"+G[z]+"</span></th>"}E+=F+"</tr></thead><tbody>";F=this._getDaysInMonth(x,p);x===a.selectedYear&&p===a.selectedMonth&&(a.selectedDay=Math.min(a.selectedDay,F));A=(this._getFirstDayOfMonth(x,p)-m+7)%7;F=Math.ceil((A+
F)/7);this.maxRows=F=t?this.maxRows>F?this.maxRows:F:F;z=this._daylightSavingAdjust(new Date(x,p,1-A));for(d=0;d<F;d++){E+="<tr>";var M=q?"<td class='ui-datepicker-week-col'>"+this._get(a,"calculateWeek")(z)+"</td>":"";for(A=0;7>A;A++){var H=B?B.apply(a.input?a.input[0]:null,[z]):[!0,""];var N=(f=z.getMonth()!==p)&&!Y||!H[0]||u&&z<u||y&&z>y;M+="<td class='"+(5<=(A+m+6)%7?" ui-datepicker-week-end":"")+(f?" ui-datepicker-other-month":"")+(z.getTime()===K.getTime()&&p===a.selectedMonth&&a._keyEvent||
U.getTime()===z.getTime()&&U.getTime()===K.getTime()?" "+this._dayOverClass:"")+(N?" "+this._unselectableClass+" ui-state-disabled":"")+(f&&!I?"":" "+H[1]+(z.getTime()===r.getTime()?" "+this._currentClass:"")+(z.getTime()===g.getTime()?" ui-datepicker-today":""))+"'"+(f&&!I||!H[2]?"":" title='"+H[2].replace(/'/g,"&#39;")+"'")+(N?"":" data-handler='selectDay' data-event='click' data-month='"+z.getMonth()+"' data-year='"+z.getFullYear()+"'")+">"+(f&&!I?"&#xa0;":N?"<span class='ui-state-default'>"+z.getDate()+
"</span>":"<a class='ui-state-default"+(z.getTime()===g.getTime()?" ui-state-highlight":"")+(z.getTime()===r.getTime()?" ui-state-active":"")+(f?" ui-priority-secondary":"")+"' href='#'>"+z.getDate()+"</a>")+"</td>";z.setDate(z.getDate()+1);z=this._daylightSavingAdjust(z)}E+=M+"</tr>"}p++;11<p&&(p=0,x++);E+="</tbody></table>"+(t?"</div>"+(0<n[0]&&c===n[1]-1?"<div class='ui-datepicker-row-break'></div>":""):"");J+=E}D+=J}a._keyEvent=!1;return D+k},_generateMonthYearHeader:function(a,b,c,d,f,g,h,k){var e,
m=this._get(a,"changeMonth"),n=this._get(a,"changeYear"),p=this._get(a,"showMonthAfterYear"),q="<div class='ui-datepicker-title'>",t="";if(g||!m)t+="<span class='ui-datepicker-month'>"+h[b]+"</span>";else{h=d&&d.getFullYear()===c;var r=f&&f.getFullYear()===c;t+="<select class='ui-datepicker-month' data-handler='selectMonth' data-event='change'>";for(e=0;12>e;e++)(!h||e>=d.getMonth())&&(!r||e<=f.getMonth())&&(t+="<option value='"+e+"'"+(e===b?" selected='selected'":"")+">"+k[e]+"</option>");t+="</select>"}p||
(q+=t+(!g&&m&&n?"":"&#xa0;"));if(!a.yearshtml)if(a.yearshtml="",g||!n)q+="<span class='ui-datepicker-year'>"+c+"</span>";else{k=this._get(a,"yearRange").split(":");var u=(new Date).getFullYear();h=function(a){a=a.match(/c[+\-].*/)?c+parseInt(a.substring(1),10):a.match(/[+\-].*/)?u+parseInt(a,10):parseInt(a,10);return isNaN(a)?u:a};b=h(k[0]);k=Math.max(b,h(k[1]||""));b=d?Math.max(b,d.getFullYear()):b;k=f?Math.min(k,f.getFullYear()):k;for(a.yearshtml+="<select class='ui-datepicker-year' data-handler='selectYear' data-event='change'>";b<=
k;b++)a.yearshtml+="<option value='"+b+"'"+(b===c?" selected='selected'":"")+">"+b+"</option>";a.yearshtml+="</select>";q+=a.yearshtml;a.yearshtml=null}q+=this._get(a,"yearSuffix");p&&(q+=(!g&&m&&n?"":"&#xa0;")+t);return q+"</div>"},_adjustInstDate:function(a,b,c){var d=a.drawYear+("Y"===c?b:0),f=a.drawMonth+("M"===c?b:0);b=Math.min(a.selectedDay,this._getDaysInMonth(d,f))+("D"===c?b:0);d=this._restrictMinMax(a,this._daylightSavingAdjust(new Date(d,f,b)));a.selectedDay=d.getDate();a.drawMonth=a.selectedMonth=
...
this.each(function(){"string"===typeof a?d.datepicker["_"+a+"Datepicker"].apply(d.datepicker,[this].concat(b)):d.datepicker._attachDatepicker(this,a)})};d.datepicker=new Q;d.datepicker.initialized=!1;d.datepicker.uuid=(new Date).getTime();d.datepicker.version="1.11.2";d.widget("ui.draggable",d.ui.mouse,{version:"1.11.2",widgetEventPrefix:"drag",options:{addClasses:!0,appendTo:"parent",axis:!1,connectToSortable:!1,containment:!1,cursor:"auto",cursorAt:!1,grid:!1,handle:!1,helper:"original",iframeFix:!1,
...
(e=!0,d.each(c.sortables,function(){this.positionAbs=c.positionAbs;this.helperProportions=c.helperProportions;this.offset.click=c.offset.click;this!==f&&this._intersectsWith(this.containerCache)&&d.contains(f.element[0],this.element[0])&&(e=!1);return e}));e?(f.isOver||(f.isOver=1,f.currentItem=b.helper.appendTo(f.element).data("ui-sortable-item",!0),f.options._helper=f.options.helper,f.options.helper=function(){return b.helper[0]},a.target=f.currentItem[0],f._mouseCapture(a,!0),f._mouseStart(a,!0,
!0),f.offset.click.top=c.offset.click.top,f.offset.click.left=c.offset.click.left,f.offset.parent.left-=c.offset.parent.left-f.offset.parent.left,f.offset.parent.top-=c.offset.parent.top-f.offset.parent.top,c._trigger("toSortable",a),c.dropped=f.element,d.each(c.sortables,function(){this.refreshPositions()}),c.currentItem=c.element,f.fromOutside=c),f.currentItem&&(f._mouseDrag(a),b.position=f.position)):f.isOver&&(f.isOver=0,f.cancelHelperRemoval=!0,f.options._revert=f.options.revert,f.options.revert=
!1,f._trigger("out",a,f._uiHash(f)),f._mouseStop(a,!0),f.options.revert=f.options._revert,f.options.helper=f.options._helper,f.placeholder&&f.placeholder.remove(),c._refreshOffsets(a),b.position=c._generatePosition(a,!0),c._trigger("fromSortable",a),c.dropped=!1,d.each(c.sortables,function(){this.refreshPositions()}))})}});d.ui.plugin.add("draggable","cursor",{start:function(a,b,c){a=d("body");c=c.options;a.css("cursor")&&(c._cursor=a.css("cursor"));a.css("cursor",c.cursor)},stop:function(a,b,c){a=
c.options;a._cursor&&d("body").css("cursor",a._cursor)}});d.ui.plugin.add("draggable","opacity",{start:function(a,b,c){a=d(b.helper);c=c.options;a.css("opacity")&&(c._opacity=a.css("opacity"));a.css("opacity",c.opacity)},stop:function(a,b,c){a=c.options;a._opacity&&d(b.helper).css("opacity",a._opacity)}});d.ui.plugin.add("draggable","scroll",{start:function(a,b,c){c.scrollParentNotHidden||(c.scrollParentNotHidden=c.helper.scrollParent(!1));c.scrollParentNotHidden[0]!==c.document[0]&&"HTML"!==c.scrollParentNotHidden[0].tagName&&
...
c){var e,f=c.options,g=f.snapTolerance,h=b.offset.left,k=h+c.helperProportions.width,l=b.offset.top,m=l+c.helperProportions.height;for(e=c.snapElements.length-1;0<=e;e--){var n=c.snapElements[e].left-c.margins.left;var p=n+c.snapElements[e].width;var q=c.snapElements[e].top-c.margins.top;var t=q+c.snapElements[e].height;if(k<n-g||h>p+g||m<q-g||l>t+g||!d.contains(c.snapElements[e].item.ownerDocument,c.snapElements[e].item))c.snapElements[e].snapping&&c.options.snap.release&&c.options.snap.release.call(c.element,
a,d.extend(c._uiHash(),{snapItem:c.snapElements[e].item})),c.snapElements[e].snapping=!1;else{if("inner"!==f.snapMode){var r=Math.abs(q-m)<=g;var u=Math.abs(t-l)<=g;var y=Math.abs(n-k)<=g;var x=Math.abs(p-h)<=g;r&&(b.position.top=c._convertPositionTo("relative",{top:q-c.helperProportions.height,left:0}).top);u&&(b.position.top=c._convertPositionTo("relative",{top:t,left:0}).top);y&&(b.position.left=c._convertPositionTo("relative",{top:0,left:n-c.helperProportions.width}).left);x&&(b.position.left=
c._convertPositionTo("relative",{top:0,left:p}).left)}var v=r||u||y||x;"outer"!==f.snapMode&&(r=Math.abs(q-l)<=g,u=Math.abs(t-m)<=g,y=Math.abs(n-h)<=g,x=Math.abs(p-k)<=g,r&&(b.position.top=c._convertPositionTo("relative",{top:q,left:0}).top),u&&(b.position.top=c._convertPositionTo("relative",{top:t-c.helperProportions.height,left:0}).top),y&&(b.position.left=c._convertPositionTo("relative",{top:0,left:n}).left),x&&(b.position.left=c._convertPositionTo("relative",{top:0,left:p-c.helperProportions.width}).left));
!c.snapElements[e].snapping&&(r||u||y||x||v)&&c.options.snap.snap&&c.options.snap.snap.call(c.element,a,d.extend(c._uiHash(),{snapItem:c.snapElements[e].item}));c.snapElements[e].snapping=r||u||y||x||v}}}});d.ui.plugin.add("draggable","stack",{start:function(a,b,c){a=d.makeArray(d(c.options.stack)).sort(function(a,b){return(parseInt(d(a).css("zIndex"),10)||0)-(parseInt(d(b).css("zIndex"),10)||0)});if(a.length){var e=parseInt(d(a[0]).css("zIndex"),10)||0;d(a).each(function(a){d(this).css("zIndex",
...
h[1]:"se")});c.autoHide&&(this._handles.hide(),d(this.element).addClass("ui-resizable-autohide").mouseenter(function(){c.disabled||(d(this).removeClass("ui-resizable-autohide"),b._handles.show())}).mouseleave(function(){c.disabled||b.resizing||(d(this).addClass("ui-resizable-autohide"),b._handles.hide())}));this._mouseInit()},_destroy:function(){this._mouseDestroy();var a=function(a){d(a).removeClass("ui-resizable ui-resizable-disabled ui-resizable-resizing").removeData("resizable").removeData("ui-resizable").unbind(".resizable").find(".ui-resizable-handle").remove()};
if(this.elementIsWrapper){a(this.element);var b=this.element;this.originalElement.css({position:b.css("position"),width:b.outerWidth(),height:b.outerHeight(),top:b.css("top"),left:b.css("left")}).insertAfter(b);b.remove()}this.originalElement.css("resize",this.originalResizeStyle);a(this.originalElement);return this},_mouseCapture:function(a){var b,c=!1;for(b in this.handles){var e=d(this.handles[b])[0];if(e===a.target||d.contains(e,a.target))c=!0}return!this.options.disabled&&c},_mouseStart:function(a){var b=
...
null;b.element.animate(d.extend(f,h&&g?{top:h,left:g}:{}),{duration:c.animateDuration,easing:c.animateEasing,step:function(){var c={width:parseInt(b.element.css("width"),10),height:parseInt(b.element.css("height"),10),top:parseInt(b.element.css("top"),10),left:parseInt(b.element.css("left"),10)};e&&e.length&&d(e[0]).css({width:c.width,height:c.height});b._updateCache(c);b._propagate("resize",a)}})}});d.ui.plugin.add("resizable","containment",{start:function(){var a=d(this).resizable("instance"),b=
a.element;var c=a.options.containment;if(b=c instanceof d?c.get(0):/parent/.test(c)?b.parent().get(0):c)if(a.containerElement=d(b),/document/.test(c)||c===document)a.containerOffset={left:0,top:0},a.containerPosition={left:0,top:0},a.parentData={element:d(document),left:0,top:0,width:d(document).width(),height:d(document).height()||document.body.parentNode.scrollHeight};else{var e=d(b);var f=[];d(["Top","Right","Left","Bottom"]).each(function(b,c){f[b]=a._num(e.css("padding"+c))});a.containerOffset=
...
b=a.options,c=a.size,e=a.originalSize,f=a.originalPosition,g=a.axis,h="number"===typeof b.grid?[b.grid,b.grid]:b.grid,k=h[0]||1,l=h[1]||1,m=Math.round((c.width-e.width)/k)*k;c=Math.round((c.height-e.height)/l)*l;var n=e.width+m,p=e.height+c,q=b.maxWidth&&b.maxWidth<n,t=b.maxHeight&&b.maxHeight<p,r=b.minWidth&&b.minWidth>n,u=b.minHeight&&b.minHeight>p;b.grid=h;r&&(n+=k);u&&(p+=l);q&&(n-=k);t&&(p-=l);if(/^(se|s|e)$/.test(g))a.size.width=n,a.size.height=p;else if(/^(ne)$/.test(g))a.size.width=n,a.size.height=
p,a.position.top=f.top-c;else if(/^(sw)$/.test(g))a.size.width=n,a.size.height=p,a.position.left=f.left-m;else{if(0>=p-l||0>=n-k)var y=a._getPaddingPlusBorderDimensions(this);0<p-l?(a.size.height=p,a.position.top=f.top-c):(p=l-y.height,a.size.height=p,a.position.top=f.top+e.height-p);0<n-k?(a.size.width=n,a.position.left=f.left-m):(n=l-y.height,a.size.width=n,a.position.left=f.left+e.width-n)}}});d.widget("ui.dialog",{version:"1.11.2",options:{appendTo:"body",autoOpen:!0,buttons:[],closeOnEscape:!0,
...
disable:d.noop,enable:d.noop,close:function(a){var b,c=this;if(this._isOpen&&!1!==this._trigger("beforeClose",a)){this._isOpen=!1;this._focusedElement=null;this._destroyOverlay();this._untrackInstance();if(!this.opener.filter(":focusable").focus().length)try{(b=this.document[0].activeElement)&&"body"!==b.nodeName.toLowerCase()&&d(b).blur()}catch(e){}this._hide(this.uiDialog,this.options.hide,function(){c._trigger("close",a)})}},isOpen:function(){return this._isOpen},moveToTop:function(){this._moveToTop()},
...
icons:{primary:"ui-icon-closethick"},text:!1}).addClass("ui-dialog-titlebar-close").appendTo(this.uiDialogTitlebar);this._on(this.uiDialogTitlebarClose,{click:function(a){a.preventDefault();this.close(a)}});var a=d("<span>").uniqueId().addClass("ui-dialog-title").prependTo(this.uiDialogTitlebar);this._title(a);this.uiDialog.attr({"aria-labelledby":a.attr("id")})},_title:function(a){this.options.title||a.html("&#160;");a.text(this.options.title)},_createButtonPane:function(){this.uiDialogButtonPane=
d("<div>").addClass("ui-dialog-buttonpane ui-widget-content ui-helper-clearfix");this.uiButtonSet=d("<div>").addClass("ui-dialog-buttonset").appendTo(this.uiDialogButtonPane);this._createButtons()},_createButtons:function(){var a=this,b=this.options.buttons;this.uiDialogButtonPane.remove();this.uiButtonSet.empty();d.isEmptyObject(b)||d.isArray(b)&&!b.length?this.uiDialog.removeClass("ui-dialog-buttons"):(d.each(b,function(b,e){e=d.isFunction(e)?{click:e,text:b}:e;e=d.extend({type:"button"},e);var c=
e.click;e.click=function(){c.apply(a.element[0],arguments)};b={icons:e.icons,text:e.showText};delete e.icons;delete e.showText;d("<button></button>",e).button(b).appendTo(a.uiButtonSet)}),this.uiDialog.addClass("ui-dialog-buttons"),this.uiDialogButtonPane.appendTo(this.uiDialog))},_makeDraggable:function(){function a(a){return{position:a.position,offset:a.offset}}var b=this,c=this.options;this.uiDialog.draggable({cancel:".ui-dialog-content, .ui-dialog-titlebar-close",handle:".ui-dialog-titlebar",
containment:"document",start:function(c,f){d(this).addClass("ui-dialog-dragging");b._blockFrames();b._trigger("dragStart",c,a(f))},drag:function(c,d){b._trigger("drag",c,a(d))},stop:function(e,f){var g=f.offset.left-b.document.scrollLeft(),h=f.offset.top-b.document.scrollTop();c.position={my:"left top",at:"left"+(0<=g?"+":"")+g+" top"+(0<=h?"+":"")+h,of:b.window};d(this).removeClass("ui-dialog-dragging");b._unblockFrames();b._trigger("dragStop",e,a(f))}})},_makeResizable:function(){function a(a){return{originalPosition:a.originalPosition,
...
a&&this._title(this.uiDialogTitlebar.find(".ui-dialog-title")))},_size:function(){var a=this.options;this.element.show().css({width:"auto",minHeight:0,maxHeight:"none",height:0});a.minWidth>a.width&&(a.width=a.minWidth);var b=this.uiDialog.css({height:"auto",width:a.width}).outerHeight();var c=Math.max(0,a.minHeight-b);var d="number"===typeof a.maxHeight?Math.max(0,a.maxHeight-b):"none";"auto"===a.height?this.element.css({minHeight:c,maxHeight:d,height:"auto"}):this.element.height(Math.max(0,a.height-
...
(this.document.data("ui-dialog-overlays")||0)+1)}},_destroyOverlay:function(){if(this.options.modal&&this.overlay){var a=this.document.data("ui-dialog-overlays")-1;a?this.document.data("ui-dialog-overlays",a):this.document.unbind("focusin").removeData("ui-dialog-overlays");this.overlay.remove();this.overlay=null}}});d.widget("ui.droppable",{version:"1.11.2",widgetEventPrefix:"drop",options:{accept:"*",activeClass:!1,addClasses:!0,greedy:!1,hoverClass:!1,scope:"default",tolerance:"intersect",activate:null,
...
lightness:{idx:2,type:"percent"}}}},m={"byte":{floor:!0,max:255},percent:{max:1},degrees:{mod:360,floor:!0}},n=k.support={},p=a("<p>")[0],q=a.each;p.style.cssText="background-color:rgba(1,1,1,.5)";n.rgba=-1<p.style.backgroundColor.indexOf("rgba");q(l,function(a,b){b.cache="_"+a;b.props.alpha={idx:3,type:"percent",def:1}});k.fn=a.extend(k.prototype,{parse:function(e,f,g,h){if(e===b)return this._rgba=[null,null,null,null],this;if(e.jquery||e.nodeType)e=a(e).css(f),f=b;var m=this,n=a.type(e),r=this._rgba=
[];f!==b&&(e=[e,f,g,h],n="array");if("string"===n)return this.parse(d(e)||t._default);if("array"===n)return q(l.rgba.props,function(a,b){r[b.idx]=c(e[b.idx],b)}),this;if("object"===n)return e instanceof k?q(l,function(a,b){e[b.cache]&&(m[b.cache]=e[b.cache].slice())}):q(l,function(b,d){var f=d.cache;q(d.props,function(a,b){if(!m[f]&&d.to){if("alpha"===a||null==e[a])return;m[f]=d.to(m._rgba)}m[f][b.idx]=c(e[a],b,!0)});m[f]&&0>a.inArray(null,m[f].slice(0,3))&&(m[f][3]=1,d.from&&(m._rgba=d.from(m[f])))}),
this},is:function(a){var b=k(a),c=!0,d=this;q(l,function(a,e){var f=b[e.cache];if(f){var g=d[e.cache]||e.to&&e.to(d._rgba)||[];q(e.props,function(a,b){if(null!=f[b.idx])return c=f[b.idx]===g[b.idx]})}return c});return c},_space:function(){var a=[],b=this;q(l,function(c,d){b[d.cache]&&a.push(c)});return a.pop()},transition:function(a,b){var d=k(a);a=d._space();var e=l[a],f=0===this.alpha()?k("transparent"):this,g=f[e.cache]||e.to(f._rgba),h=g.slice();d=d[e.cache];q(e.props,function(a,e){a=e.idx;var f=
g[a],k=d[a],l=m[e.type]||{};null!==k&&(null===f?h[a]=k:(l.mod&&(k-f>l.mod/2?f+=l.mod:f-k>l.mod/2&&(f-=l.mod)),h[a]=c((k-f)*b+f,e)))});return this[a](h)},blend:function(b){if(1===this._rgba[3])return this;var c=this._rgba.slice(),d=c.pop(),e=k(b)._rgba;return k(a.map(c,function(a,b){return(1-d)*e[b]+d*a}))},toRgbaString:function(){var b="rgba(",c=a.map(this._rgba,function(a,b){return null==a?2<b?1:0:a});1===c[3]&&(c.pop(),b="rgb(");return b+c.join()+")"},toHslaString:function(){var b="hsla(",c=a.map(this.hsla(),
...
d){b["border"+d+"Color"]=a});return b}};var t=a.Color.names={aqua:"#00ffff",black:"#000000",blue:"#0000ff",fuchsia:"#ff00ff",gray:"#808080",green:"#008000",lime:"#00ff00",maroon:"#800000",navy:"#000080",olive:"#808000",purple:"#800080",red:"#ff0000",silver:"#c0c0c0",teal:"#008080",white:"#ffffff",yellow:"#ffff00",transparent:[null,null,null,0],_default:"#ffffff"}})(d);(function(){function a(a){var b=a.ownerDocument.defaultView?a.ownerDocument.defaultView.getComputedStyle(a,null):a.currentStyle,c=
{};if(b&&b.length&&b[0]&&b[b[0]])for(a=b.length;a--;){var e=b[a];"string"===typeof b[e]&&(c[d.camelCase(e)]=b[e])}else for(e in b)"string"===typeof b[e]&&(c[e]=b[e]);return c}var b=["add","remove","toggle"],c={border:1,borderBottom:1,borderColor:1,borderLeft:1,borderRight:1,borderTop:1,borderWidth:1,margin:1,padding:1};d.each(["borderLeftStyle","borderRightStyle","borderBottomStyle","borderTopStyle"],function(a,b){d.fx.step[b]=function(a){if("none"!==a.end&&!a.setAttr||1===a.pos&&!a.setAttr)d.style(a.elem,
b,a.end),a.setAttr=!0}});d.fn.addBack||(d.fn.addBack=function(a){return this.add(null==a?this.prevObject:this.prevObject.filter(a))});d.effects.animateClass=function(e,f,g,h){var k=d.speed(f,g,h);return this.queue(function(){var f=d(this),g=f.attr("class")||"",h=k.children?f.find("*").addBack():f;h=h.map(function(){return{el:d(this),start:a(this)}});var p=function(){d.each(b,function(a,b){if(e[b])f[b+"Class"](e[b])})};p();h=h.map(function(){this.end=a(this.el[0]);var b=this.start,e=this.end,f={},
g;for(g in e){var h=e[g];b[g]===h||c[g]||!d.fx.step[g]&&isNaN(parseFloat(h))||(f[g]=h)}this.diff=f;return this});f.attr("class",g);h=h.map(function(){var a=this,b=d.Deferred(),c=d.extend({},k,{queue:!1,complete:function(){b.resolve(a)}});this.el.animate(this.diff,c);return b.promise()});d.when.apply(d,h.get()).done(function(){p();d.each(arguments,function(){var a=this.el;d.each(this.diff,function(b){a.css(b,"")})});k.complete.call(f[0])})})};d.fn.extend({addClass:function(a){return function(b,c,e,
...
"both";var q=a.origin||["middle","center"];var t=c.css("position"),r=n?e:f,u={height:0,width:0,outerHeight:0,outerWidth:0};"show"===m&&c.show();f={height:c.height(),width:c.width(),outerHeight:c.outerHeight(),outerWidth:c.outerWidth()};"toggle"===a.mode&&"show"===m?(c.from=a.to||u,c.to=a.from||f):(c.from=a.from||("show"===m?u:f),c.to=a.to||("hide"===m?u:f));var y=c.from.height/f.height;var x=c.from.width/f.width;var v=c.to.height/f.height;var w=c.to.width/f.width;if("box"===p||"both"===p)y!==v&&(r=
r.concat(k),c.from=d.effects.setTransition(c,k,y,c.from),c.to=d.effects.setTransition(c,k,v,c.to)),x!==w&&(r=r.concat(l),c.from=d.effects.setTransition(c,l,x,c.from),c.to=d.effects.setTransition(c,l,w,c.to));"content"!==p&&"both"!==p||y===v||(r=r.concat(h).concat(g),c.from=d.effects.setTransition(c,h,y,c.from),c.to=d.effects.setTransition(c,h,v,c.to));d.effects.save(c,r);c.show();d.effects.createWrapper(c);c.css("overflow","hidden").css(c.from);q&&(q=d.effects.getBaseline(q,f),c.from.top=(f.outerHeight-
c.outerHeight())*q.y,c.from.left=(f.outerWidth-c.outerWidth())*q.x,c.to.top=(f.outerHeight-c.to.outerHeight)*q.y,c.to.left=(f.outerWidth-c.to.outerWidth)*q.x);c.css(c.from);if("content"===p||"both"===p)k=k.concat(["marginTop","marginBottom"]).concat(h),l=l.concat(["marginLeft","marginRight"]),g=e.concat(k).concat(l),c.find("*[width]").each(function(){var b=d(this),c=b.height(),e=b.width(),f=b.outerHeight(),h=b.outerWidth();n&&d.effects.save(b,g);b.from={height:c*y,width:e*x,outerHeight:f*y,outerWidth:h*
x};b.to={height:c*v,width:e*w,outerHeight:c*v,outerWidth:e*w};y!==v&&(b.from=d.effects.setTransition(b,k,y,b.from),b.to=d.effects.setTransition(b,k,v,b.to));x!==w&&(b.from=d.effects.setTransition(b,l,x,b.from),b.to=d.effects.setTransition(b,l,w,b.to));b.css(b.from);b.animate(b.to,a.duration,a.easing,function(){n&&d.effects.restore(b,g)})});c.animate(c.to,{queue:!1,duration:a.duration,easing:a.easing,complete:function(){0===c.to.opacity&&c.css("opacity",c.from.opacity);"hide"===m&&c.hide();d.effects.restore(c,
r);n||("static"===t?c.css({position:"relative",top:c.to.top,left:c.to.left}):d.each(["top","left"],function(a,b){c.css(b,function(b,d){b=parseInt(d,10);var e=a?c.to.left:c.to.top;return"auto"===d?e+"px":b+e+"px"})}));d.effects.removeWrapper(c);b()}})};d.effects.effect.scale=function(a,b){var c=d(this),e=d.extend(!0,{},a),f=d.effects.setMode(c,a.mode||"effect"),g=parseInt(a.percent,10)||(0===parseInt(a.percent,10)?0:"hide"===f?0:100),h=a.direction||"both",k=a.origin,l={height:c.height(),width:c.width(),
outerHeight:c.outerHeight(),outerWidth:c.outerWidth()},m="horizontal"!==h?g/100:1;g="vertical"!==h?g/100:1;e.effect="size";e.queue=!1;e.complete=b;"effect"!==f&&(e.origin=k||["middle","center"],e.restore=!0);e.from=a.from||("show"===f?{height:0,width:0,outerHeight:0,outerWidth:0}:l);e.to={height:l.height*m,width:l.width*g,outerHeight:l.outerHeight*m,outerWidth:l.outerWidth*g};e.fade&&("show"===f&&(e.from.opacity=0,e.to.opacity=1),"hide"===f&&(e.from.opacity=1,e.to.opacity=0));c.effect(e)};d.effects.effect.puff=
...
(d.ui.ddmanager.current=this);d.ui.ddmanager&&!b.dropBehaviour&&d.ui.ddmanager.prepareOffsets(this,a);this.dragging=!0;this.helper.addClass("ui-sortable-helper");this._mouseDrag(a);return!0},_mouseDrag:function(a){var b;var c=this.options;var e=!1;this.position=this._generatePosition(a);this.positionAbs=this._convertPositionTo("absolute");this.lastPositionAbs||(this.lastPositionAbs=this.positionAbs);this.options.scroll&&(this.scrollParent[0]!==document&&"HTML"!==this.scrollParent[0].tagName?(this.overflowOffset.top+
...
f=d+this.helperProportions.height,g=a.left,h=g+a.width,k=a.top,l=k+a.height,m=this.offset.click.top,n=this.offset.click.left;m="x"===this.options.axis||d+m>k&&d+m<l;n="y"===this.options.axis||b+n>g&&b+n<h;return"pointer"===this.options.tolerance||this.options.forcePointerForContainers||"pointer"!==this.options.tolerance&&this.helperProportions[this.floating?"width":"height"]>a[this.floating?"width":"height"]?m&&n:g<b+this.helperProportions.width/2&&c-this.helperProportions.width/2<h&&k<d+this.helperProportions.height/
...
e.left,this.containers[b].containerCache.top=e.top,this.containers[b].containerCache.width=this.containers[b].element.outerWidth(),this.containers[b].containerCache.height=this.containers[b].element.outerHeight();return this},_createPlaceholder:function(a){a=a||this;var b=a.options;if(!b.placeholder||b.placeholder.constructor===String){var c=b.placeholder;b.placeholder={element:function(){var b=a.currentItem[0].nodeName.toLowerCase(),f=d("<"+b+">",a.document[0]).addClass(c||a.currentItem[0].className+
" ui-sortable-placeholder").removeClass("ui-sortable-helper");"tr"===b?a.currentItem.children().each(function(){d("<td>&#160;</td>",a.document[0]).attr("colspan",d(this).attr("colspan")||1).appendTo(f)}):"img"===b&&f.attr("src",a.currentItem.attr("src"));c||f.css("visibility","hidden");return f},update:function(d,f){if(!c||b.forcePlaceholderSize)f.height()||f.height(a.currentItem.innerHeight()-parseInt(a.currentItem.css("paddingTop")||0,10)-parseInt(a.currentItem.css("paddingBottom")||0,10)),f.width()||
f.width(a.currentItem.innerWidth()-parseInt(a.currentItem.css("paddingLeft")||0,10)-parseInt(a.currentItem.css("paddingRight")||0,10))}}}a.placeholder=d(b.placeholder.element.call(a.element,a.currentItem));a.currentItem.after(a.placeholder);b.placeholder.update(a,a.placeholder)},_contactContainers:function(a){var b,c,e,f=e=null;for(b=this.containers.length-1;0<=b;b--)d.contains(this.currentItem[0],this.containers[b].element[0])||(this._intersectsWith(this.containers[b].containerCache)?e&&d.contains(this.containers[b].element[0],
e.element[0])||(e=this.containers[b],f=b):this.containers[b].containerCache.over&&(this.containers[b]._trigger("out",a,this._uiHash(this)),this.containers[b].containerCache.over=0));if(e)if(1===this.containers.length)this.containers[f].containerCache.over||(this.containers[f]._trigger("over",a,this._uiHash(this)),this.containers[f].containerCache.over=1);else{b=1E4;var g=null;e=(c=e.floating||this._isFloating(this.currentItem))?"left":"top";var h=c?"width":"height";var k=c?"clientX":"clientY";for(c=
this.items.length-1;0<=c;c--)if(d.contains(this.containers[f].element[0],this.items[c].item[0])&&this.items[c].item[0]!==this.currentItem[0]){var l=this.items[c].item.offset()[e];var m=!1;a[k]-l>this.items[c][h]/2&&(m=!0);Math.abs(a[k]-l)<b&&(b=Math.abs(a[k]-l),g=this.items[c],this.direction=m?"up":"down")}if(g||this.options.dropOnEmpty)this.currentContainer===this.containers[f]?this.currentContainer.containerCache.over||(this.containers[f]._trigger("over",a,this._uiHash()),this.currentContainer.containerCache.over=
...
_stepUp:function(a){this._start()&&(this._spin((a||1)*this.options.step),this._stop())},stepDown:D(function(a){this._stepDown(a)}),_stepDown:function(a){this._start()&&(this._spin((a||1)*-this.options.step),this._stop())},pageUp:D(function(a){this._stepUp((a||1)*this.options.page)}),pageDown:D(function(a){this._stepDown((a||1)*this.options.page)}),value:function(a){if(!arguments.length)return this._parse(this.element.val());D(this._value).call(this,a)},widget:function(){return this.uiSpinner}});d.widget("ui.tabs",
...
f){if(d(f).attr("aria-controls")===c)return a=b,!1}),null===a&&(a=this.tabs.index(this.tabs.filter(".ui-tabs-active"))),null===a||-1===a)&&(a=this.tabs.length?0:!1);!1!==a&&(a=this.tabs.index(this.tabs.eq(a)),-1===a&&(a=b?!1:0));!b&&!1===a&&this.anchors.length&&(a=0);return a},_getCreateEventData:function(){return{tab:this.active,panel:this.active.length?this._getPanelForTab(this.active):d()}},_tabKeydown:function(a){var b=d(this.document[0].activeElement).closest("li"),c=this.tabs.index(b),e=!0;
...
this.options.disabled;if(!0!==b){if(void 0===a)b=!0;else{a=this._getIndex(a);if(-1!==d.inArray(a,b))return;b=d.isArray(b)?d.merge([a],b).sort():[a]}this._setupDisabled(b)}},load:function(a,b){a=this._getIndex(a);var c=this,e=this.tabs.eq(a);a=e.find(".ui-tabs-anchor");var f=this._getPanelForTab(e),g={tab:e,panel:f};this._isLocal(a[0])||(this.xhr=d.ajax(this._ajaxSettings(a,b,g)))&&"canceled"!==this.xhr.statusText&&(e.addClass("ui-tabs-loading"),f.attr("aria-busy","true"),this.xhr.success(function(a){setTimeout(function(){f.html(a);
...
c.target=c.currentTarget=this;b.close(c,!0)}a.attr("title")&&(a.uniqueId(),b.parents[this.id]={element:this,title:a.attr("title")},a.attr("title",""))}),this._updateContent(c,a))},_updateContent:function(a,b){var c=this.options.content;var d=this,f=b?b.type:null;if("string"===typeof c)return this._open(b,a,c);(c=c.call(a[0],function(c){a.data("ui-tooltip-open")&&d._delay(function(){b&&(b.type=f);this._open(b,a,c)})}))&&this._open(b,a,c)},_open:function(a,b,c){function e(a){g.of=a;h.is(":hidden")||
h.position(g)}var f,g=d.extend({},this.options.position);if(c)if(f=this._find(b))f.tooltip.find(".ui-tooltip-content").html(c);else{b.is("[title]")&&(a&&"mouseover"===a.type?b.attr("title",""):b.removeAttr("title"));f=this._tooltip(b);var h=f.tooltip;this._addDescribedBy(b,h.attr("id"));h.find(".ui-tooltip-content").html(c);this.liveRegion.children().hide();c.clone&&(c=c.clone(),c.removeAttr("id").find("[id]").removeAttr("id"));d("<div>").html(c).appendTo(this.liveRegion);this.options.track&&a&&/^mouse/.test(a.type)?
(this._on(this.document,{mousemove:e}),e(a)):h.position(d.extend({of:b},this.options.position));h.hide();this._show(h,this.options.show);if(this.options.show&&this.options.show.delay)var k=this.delayedShow=setInterval(function(){h.is(":visible")&&(e(g.of),clearInterval(k))},d.fx.interval);this._trigger("open",a,{tooltip:h});c={keyup:function(a){a.keyCode===d.ui.keyCode.ESCAPE&&(a=d.Event(a),a.currentTarget=b[0],this.close(a,!0))}};b[0]!==this.element[0]&&(c.remove=function(){this._removeTooltip(h)});
